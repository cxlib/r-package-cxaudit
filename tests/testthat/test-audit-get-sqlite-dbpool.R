...
testthat::test_that( "audit.get.auditEnableSQLiteDbPoolNoRefId", {
...
testthat::test_that( "audit.get.auditEnableSQLiteDbPoolRefIdNull", {
...
testthat::test_that( "audit.get.auditEnableSQLiteDbPoolRefIdInvalid", {
...
testthat::test_that( "audit.get.auditEnableSQLiteDbPoolValidRefIdEmptyDatabase", {
...
testthat::test_that( "audit.get.auditEnableSQLiteDbPoolValidByRefId", {
...
testthat::test_that( "audit.get.auditEnableSQLiteDbPoolValidByObject", {
